...
export async function getStaticProps(): Promise<{ props: GameTemplateProps }> {
  return {
    props: {
...
const descriptionHTML = `
  ...
  <center><a href="https://www.cyberpunk.net/en/news/41435/patch-1-5-next-generation-update-list-of-changes"><img src="https://items.gog.com/not_a_cp/1.5patchbox.jfif"></a></center>
  <hr>
